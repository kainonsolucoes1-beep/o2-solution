...
def conversao_por_fonte(
    ...
    # Renutrição counts per origin (subset — not a new origin). Canais e pontos
    # de conversão são sobre a FONTE do lead, então renutrição fica sob a origem
    # original (quem trabalha a renutrição aparece como operador na "Vida do
    # Agente" e no Ranking do Dashboard, não aqui).
    rn_leads = (

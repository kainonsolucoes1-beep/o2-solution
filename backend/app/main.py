...
with engine.connect() as _conn:
    ...
    _conn.execute(text("ALTER TABLE lead_notes ADD COLUMN IF NOT EXISTS edited_at TIMESTAMP"))
    _conn.execute(text("ALTER TABLE lead_notes ADD COLUMN IF NOT EXISTS edited_by VARCHAR(255)"))
